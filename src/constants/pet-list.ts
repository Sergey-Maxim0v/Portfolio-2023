...
export const PET_LIST: IPetProject[] = [
  ...
  },
  {
    ...
    photos: [
      "pet-5-crm-app.png",
      "pet-5-crm-filter-sort.png",
      "pet-5-crm-modal-add.png",
      "pet-5-crm-modal-delete.png",
      "pet-5-crm-modal-error.png",
      "pet-5-crm-modal-update.png",
      "pet-5-crm-select.png",
    ],
