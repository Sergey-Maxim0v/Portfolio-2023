...
const ThemeSwitcher: FC<IThemeSwitcher> = ({className}) => {
  ...
  return (
      ...
      >
        ...
        <svg className={styles.themeSwitcher__sun} width="800px" height="800px" viewBox="0 0 24 24" fill="none"
             xmlns="http://www.w3.org/2000/svg">
          <circle cx="12" cy="12" r="4.14113" stroke="currentColor" strokeWidth="1.91129"/>
          <path className={styles.themeSwitcher__animation1} fillRule="evenodd" clipRule="evenodd"
                ...
                fill="currentColor"/>
          <path className={styles.themeSwitcher__animation2} fillRule="evenodd" clipRule="evenodd"
                ...
                fill="currentColor"/>
          <path className={styles.themeSwitcher__animation3} fillRule="evenodd" clipRule="evenodd"
